...
class Particle
{
    constructor()
    {
        //objeto que recoge la imagen
        this.img = graphicAssets.partycle.image;

        //recoge el tamaño de la imagen y la regula
        ...
        //para saber si esta en pantalla
        ...
        //recoge si se tiene que eliminar
        this.toDelete = false;
...
class ParticleSystem
{
    constructor (maxParticleCount = 100)
    {
        ...
        this.MAX_OPACITY_DECREMENT_VELOCITY_VALUE = 4;

        this.MIN_INITIAL_SCALE = 0.1;
        this.MAX_INITIAL_SCALE = 0.3;
        ...
        this.MAX_ROTATION_VELOCITY = 0.2;
    ...
    Update(deltaTime)
    {
        ...
        if (this.nextTimeToSpawnParticle <= 0.0) {
            ...
            let i;
            for (i = 4; i < this.particles.length; i++)
            {
